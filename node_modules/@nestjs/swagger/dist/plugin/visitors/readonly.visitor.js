...
class ReadonlyVisitor {
    ...
    visit(program, sf) {
        ...
        if (compilerOptions.outDir) {
            (_a = (_c = this.options).outDir) !== null && _a !== void 0 ? _a : (_c.outDir = compilerOptions.outDir);
        }
        if (compilerOptions.rootDir) {
            (_b = (_d = this.options).rootDir) !== null && _b !== void 0 ? _b : (_d.rootDir = compilerOptions.rootDir);
        }

...
exports.collectExistingApiParamNames = collectExistingApiParamNames;
exports.getNamedParamDecoratorArg = getNamedParamDecoratorArg;
...
function isBoolean(type) {
    return (hasFlag(type, typescript_1.TypeFlags.Boolean) || hasFlag(type, typescript_1.TypeFlags.BooleanLiteral));
}
function isBooleanLiteral(type) {
    return hasFlag(type, typescript_1.TypeFlags.BooleanLiteral) && !type.isUnion();
}
...
function collectExistingApiParamNames(methodDecorators, apiDecoratorName) {
    const names = new Set();
...
function getNamedParamDecoratorArg(parameter, decoratorName) {

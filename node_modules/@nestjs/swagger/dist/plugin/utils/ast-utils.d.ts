...
export declare function isBooleanLiteral(type: Type): boolean;
...
export declare function collectExistingApiParamNames(methodDecorators: readonly Decorator[], apiDecoratorName: string): Set<string> | null;
export declare function getNamedParamDecoratorArg(parameter: ts.ParameterDeclaration, decoratorName: string): string | undefined;
...
export declare function createLiteralFromAnyValue(factory: ts.NodeFactory, item: unknown): ts.Expression;

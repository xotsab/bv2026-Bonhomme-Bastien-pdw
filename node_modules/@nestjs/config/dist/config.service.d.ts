...
export declare class ConfigService<K = Record<string | symbol, unknown>, WasValidated extends boolean = false> {
     ...
     * @param options
     */
    get<T = K, P extends Path<T> = any, R extends PathValue<T, P> = PathValue<T, P>>(propertyPath: P, options: ConfigGetOptions): ValidatedResult<WasValidated, R>;
    /**
     * Get a configuration value (either custom configuration or process environment variable)
     * based on property path (you can use dot notation to traverse nested object, e.g. "database.host").
     ...
     * @param options
     */
    get<T = K, P extends Path<T> = any, R extends PathValue<T, P> = PathValue<T, P>>(propertyPath: P, defaultValue: NoInferType<R>, options: ConfigGetOptions): Exclude<R, undefined>;
    /**
     * Get a configuration value (either custom configuration or process environment variable)
     * based on property path (you can use dot notation to traverse nested object, e.g. "database.host").
     * @param propertyPath
     ...
     * @param options
     */
    getOrThrow<T = K, P extends Path<T> = any, R extends PathValue<T, P> = PathValue<T, P>>(propertyPath: P, options: ConfigGetOptions): Exclude<R, undefined>;
    /**
     * Get a configuration value (either custom configuration or process environment variable)
     * based on property path (you can use dot notation to traverse nested object, e.g. "database.host").
     * It returns a default value if the key does not exist.
     ...
     * @param options
     */
    getOrThrow<T = K, P extends Path<T> = any, R extends PathValue<T, P> = PathValue<T, P>>(propertyPath: P, defaultValue: NoInferType<R>, options: ConfigGetOptions): Exclude<R, undefined>;
    /**

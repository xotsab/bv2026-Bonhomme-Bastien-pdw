...
const backportJestConfig = (logger, config) => {
    ...
    const warnConfig = (oldPath, newPath, note) => {
        hadWarnings = true;
        logger.warn(context, (0, messages_1.interpolate)(note ? messages_1.Deprecations.ConfigOptionWithNote : messages_1.Deprecations.ConfigOption, {
            oldPath,
            newPath,
            note,
        }));
    ...
    if ('useBabelrc' in tsJest) {
        warnConfig('globals.ts-jest.useBabelrc', 'globals.ts-jest.babelConfig', messages_1.Deprecations.ConfigOptionUseBabelRcNote);
...
const backportTsJestDebugEnvVar = (logger) => {
    if ('TS_JEST_DEBUG' in process.env) {
        ...
        logger.warn(context, (0, messages_1.interpolate)(messages_1.Deprecations.EnvVar, {
            old: 'TS_JEST_DEBUG',
            new: 'TS_JEST_LOG',
        }));
    }

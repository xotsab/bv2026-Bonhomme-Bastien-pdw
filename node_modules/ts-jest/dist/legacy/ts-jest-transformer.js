...
class TsJestTransformer {
        ...
        if (ccs) {
            ...
            if (serializedCcs) {
                ...
                if (config.globals?.['ts-jest']) {
                    this._logger.warn(messages_1.Deprecations.GlobalsTsJestConfigOption);
                }
    ...
    processWithTs(sourceText, sourcePath, transformOptions) {
        ...
        if (shouldStringifyContent) {
            ...
            const message = babelJest ? messages_1.Errors.GotUnknownFileTypeWithBabel : messages_1.Errors.GotUnknownFileTypeWithoutBabel;

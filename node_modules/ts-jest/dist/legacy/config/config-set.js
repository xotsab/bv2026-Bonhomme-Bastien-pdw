...
class ConfigSet {
    ...
    constructor(jestConfig, parentLogger) {
        ...
        // compiler module
        this.compilerModule = importer_1.importer.typescript(messages_1.ImportReasons.TsJest, options.compiler ?? 'typescript');
        ...
        if (options.isolatedModules) {
            ...
            if (this.tsconfigFilePath) {
                this.logger.warn((0, messages_1.interpolate)(messages_1.Deprecations.IsolatedModulesWithTsconfigPath, {
                    tsconfigFilePath: this.tsconfigFilePath,
                }));
            }
            else {
                this.logger.warn(messages_1.Deprecations.IsolatedModulesWithoutTsconfigPath);
            }
        }
    ...
    _setupConfigSet(options) {
        ...
        if (!options.babelConfig) {
            ...
            this.babelJestTransformer = importer_1.importer
                .babelJest(messages_1.ImportReasons.BabelJest)
            ...
            const resolveTransformerFunc = (transformerPath) => {
                ...
                if ((0, path_1.extname)(transformerPath) === '.ts') {
                    const compiledTransformer = importer_1.importer
                        .esBuild(messages_1.ImportReasons.EsBuild)
                ...
                if (!transformerFunc.version) {
                    this.logger.warn(messages_1.Errors.MissingTransformerVersion, { file: transformerPath });
                }
                if (!transformerFunc.name) {
                    this.logger.warn(messages_1.Errors.MissingTransformerName, { file: transformerPath });
                }
    ...
    _getAndResolveTsConfig(compilerOptions, resolvedConfigFile) {
        ...
        if (!this.babelConfig &&
            ...
            result.errors.push({
                ...
                messageText: messages_1.Errors.ConfigNoModuleInterop,
        ...
        if (compilationTarget &&
            ...
            const message = (0, messages_1.interpolate)(messages_1.Errors.MismatchNodeTargetMapping, {
    ...
    resolvePath(inputPath, { throwIfMissing = true, nodeResolve = false } = {}) {
        ...
        if (throwIfMissing && !(0, fs_1.existsSync)(path)) {
            throw new Error((0, messages_1.interpolate)(messages_1.Errors.FileNotFound, { inputPath, resolvedPath: path }));
        }

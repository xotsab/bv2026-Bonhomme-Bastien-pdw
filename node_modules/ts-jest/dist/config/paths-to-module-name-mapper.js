...
const pathsToModuleNameMapper = (mapping, { prefix = '', useESM = false } = {}) => {
    ...
    for (const fromPath of Object.keys(mapping)) {
        ...
        if (toPaths.length === 0) {
            logger.warn((0, messages_1.interpolate)(messages_1.Errors.NotMappingPathWithEmptyMap, { path: fromPath }));
            continue;
        }
        // split with '*'
        ...
        if (segments.length === 1) {
            ...
            logger.warn((0, messages_1.interpolate)(messages_1.Errors.NotMappingMultiStarPath, { path: fromPath }));
        }
    }
    if (useESM) {
        jestMap['^(\\.{1,2}/.*)\\.js$'] = '$1';
